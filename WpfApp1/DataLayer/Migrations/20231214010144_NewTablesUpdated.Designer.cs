...
namespace DataLayer.Migrations
{
    ...
    [Migration("20231214010144_NewTablesUpdated")]
    partial class NewTablesUpdated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Model.OrderStatus", b =>
                {
                    b.Property<int>("OrderStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Model.OrderStatus", b =>
                {
                    b.HasOne("DataLayer.Model.Order", "Order")
                        .WithOne("OrderStatus")
                        .HasForeignKey("DataLayer.Model.OrderStatus", "OrderID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
